...
public interface ProductCategoryMapper {
    ...
    ProductCategoryDto updateCategoryById(@Param("id") long id, @Param("name") String name, @Param("description") String description, @Param("modifiedDate") String modifiedDate);
